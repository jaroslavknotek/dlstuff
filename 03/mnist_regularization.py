...
reg = None
if (args.l2 != 0):
    reg = tf.keras.regularizers.L1L2(0, args.l2)
...
for hidden_layer in args.hidden_layers:
    ...
    model.add(tf.keras.layers.Dropout(args.dropout))
model.add(tf.keras.layers.Dense(MNIST.LABELS, kernel_regularizer=reg, bias_regularizer=reg))
...
if args.label_smoothing > 0:
    ...
    train_labels = tf.keras.utils.to_categorical(mnist.train.data["labels"][:5000])
